...
export function sitemap(catalog) {
  ...
  const pageCount = Math.max(1, Math.ceil(home.length / PAGE_SIZE));
  const entries = Array.from({length:pageCount}, (_, i) => ({path:archivePath(i+1), photos:home.slice(i*PAGE_SIZE,(i+1)*PAGE_SIZE)}));
